                    ...
                    children: <Widget>[
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('Rp6.000.000', style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          SizedBox(
                            height: 5,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('12 bulan', style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          SizedBox(
                            height: 5,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('Rp560.000,00', style: TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                      SizedBox(height: 20,
                      child: Divider(color: Colors.black,),),
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'ini gimana biar bisa masukin textfield?! error mulu:(', 
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            primary: Color(0xff069A8E), // Background color
                          ),
                          onPressed: () {
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('  alert dialognya masih error :(')
                            ],
                          ),
                        )
                      ),
